...
def compute_circles(circles_number, length, width, car_position, car_yaw):
    ...
    # Definition of the car's clockwise rotation matrix
    R = [[math.cos(car_yaw), math.sin(car_yaw)], [-math.sin(car_yaw), math.cos(car_yaw)]]
