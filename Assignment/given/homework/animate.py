...
def _prepare_output_path(filename: str, ext: str = "gif"):
...
def animate_iterates(its: List[NLIterate], filename: str = "Iterates.gif"):
...
def animate_positions(its: List[NLIterate], filename: str = "Iterates.gif"):
    fig = plt.figure()
